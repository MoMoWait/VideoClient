 ...
 * A simple subclass of {@link ImageResizer} that fetches and
...
public class ImageFetcher extends ImageResizer {
    ...
    private void init(Context context){
        ...
        mHttpCacheDir = momo.cn.edu.fjnu.videoclient.utils.ImageCache.getDiskCacheDir(context, HTTP_CACHE_DIR);
    }
