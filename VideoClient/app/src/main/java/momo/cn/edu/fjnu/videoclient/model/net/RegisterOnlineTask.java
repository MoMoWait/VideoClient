 ...
 */
public class RegisterOnlineTask extends AsyncTask<String, Integer, Integer>{
    public static final String TAG = RegisterOnlineTask.class.getSimpleName();
    ...
    public RegisterOnlineTask(CallBack callBack){
    ...
    protected Integer doInBackground(String... params) {
        ...
        reqParams.put("address", params[1]);
        reqParams.put("lng", params[2]);
        reqParams.put("lat", params[3]);
        try {
            mJsonResult = NetService.request("RegisterOnlineService", reqParams);
