package momo.cn.edu.fjnu.vlclib.activity;
...
import momo.cn.edu.fjnu.vlclib.R;
import momo.cn.edu.fjnu.vlclib.view.PlayerView;
...
public class PlayerActivity extends Activity implements PlayerView.OnChangeListener, OnClickListener, OnSeekBarChangeListener, Callback {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		//mUrl = "rtsp://120.24.210.186:1935/vod/sample.mp4";
	...
	public void onClick(View view) {
		...
		} else if (id == R.id.ib_backward) {
			mPlayerView.seek(-10000);
		} else if (id == R.id.ib_size) {
		} else {
		}
	}
